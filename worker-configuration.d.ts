/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7c21845f135fd521ae6d9fbef8cce562)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	BACKUP_QUEUE: Queue;
	GRAPH_APP_SECRET: SecretsStoreSecret;
	TENANT: DurableObjectNamespace<import('./src/index').TenantCoordinator>;
	BACKUP_WORKFLOW: Workflow<Parameters<import('./src/index').BackupWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./src/index');
		durableNamespaces: 'TenantCoordinator';
	}
